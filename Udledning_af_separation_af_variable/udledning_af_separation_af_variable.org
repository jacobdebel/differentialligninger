#+title: Bevis for separation af de variable til løsning af differentialligninger
#+subtitle: 
#+author: Matematik A
...
#+latex_header: \usepackage[left=1.0cm,right=1.0cm,top=0.0cm,bottom=1.5cm]{geometry}
